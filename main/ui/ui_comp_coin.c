...
lv_obj_t * ui_coin_create(lv_obj_t *comp_parent) {
    ...
    lv_obj_set_style_pad_all(cui_coin, 2, LV_PART_MAIN);
    ...
    lv_obj_set_height(cui_desription_price, 25);   /// 1
    ...
    lv_obj_set_style_text_font(cui_desription_price, &lv_font_montserrat_14, LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_text_font(cui_items_value, &lv_font_montserrat_14, LV_PART_MAIN | LV_STATE_DEFAULT);
